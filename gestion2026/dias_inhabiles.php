        ...
        <div class="col-12 ">
            <table class="table " id="tablaDiasI">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Noviembre</td>
                        <td>Días Inhábiles</td>
                        <td><i class="fa fa-calendar-check-o" aria-hidden="true"></i> 1, 2 y 16</td>
                    </tr>
                    <tr>
                        <td>Diciembre</td>
                        <td>Días Inhábiles</td>
                        <td><i class="fa fa-calendar-check-o" aria-hidden="true"></i> 12 y 25</td>
                    </tr>
                </tbody>
            </table>
        </div>
