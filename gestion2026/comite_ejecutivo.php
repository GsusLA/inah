    ...
    var app = new Vue({
        ...
        data: {
            ...
            integrantes:[
                ...
                {
                    nombre:'Jesús Ernesto Velasco González',
                ...
                {
                    nombre:'Fernando Alberto Miranda Flores',
                ...
                {
                    nombre:'Rosa María Vanegas García',
                    cargo:'Secretaría de Trabajo, Conflictos, Previsión y Asistencia Social	',
                    lugar:'',
                    imagen:'assets/img/logo-inah-t.png',
                    resumen:""
                },
                {
                    nombre:'Allan Ortega Muñoz',
                ...
                {
                    nombre:'Verónica Rodríguez Manzo',
